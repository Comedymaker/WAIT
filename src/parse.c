...
void parseType(wasm_module_ptr module, bytes start, bytes end);
void parseImport(wasm_module_ptr module, bytes start, bytes end);
void parseFunction(wasm_module_ptr module, bytes start, bytes end);
void parseMemory(wasm_module_ptr module, bytes start, bytes end);
void parseGlobal(wasm_module_ptr module, bytes start, bytes end);
// void ParseSection_Start(wasm_module_ptr module, bytes start, bytes end);
void parseCode(wasm_module_ptr module, bytes start, bytes end);
void parseData(wasm_module_ptr module, bytes start, bytes end);
